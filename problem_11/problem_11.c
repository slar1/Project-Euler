...
int main() {
  // Got chatgpt to make the matrix. Hopefully it made it correctly, might have
  // to check through it if it doesn't work.
  ...
  for (int row = 0; row < 20; row++) {
    for (int column = 0; column < 17; column++) {
      int product = matrix[row][column] * matrix[row][column + 1] *
  ...
  for (int row = 0; row < 17; row++) {
    for (int column = 0; column < 20; column++) {
      int product = matrix[row][column] * matrix[row + 1][column] *
  ...
  for (int row = 0; row < 17; row++) {
    for (int column = 0; column < 17; column++) {
      int product = matrix[row][column] * matrix[row + 1][column + 1] *
